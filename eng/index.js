...
var print_date_fmt = d3.timeFormat('%B %d, %Y %H:%M');
...
var sites_headlines = {
    ...
    'links_net': [
        'Links between sites',
        '<p>Coloured lines link to sources for website in ranking. Grey lines indicate links to website not in the ranking</p>'
    ],
    'about_ru': [
        'Russian Propaganda',
        '<p>By total manipulativeness rank</p>'
    ]
};
            ...
            site_divs
                .attr('data-tippy-content', function (d) {
                    return `<h6>${d.comment || d.url_domain}</h6>
                        <p>Visits per month: ${d3.format(".2s")(d.ukr_audience)}</p>
                        <p>News containing emotional manipulations: ${d3.format(".2%")(d.emo_pers)}</p>
                        `;
                });
                    ...
                    if (r.element.id === 'links_net') {
                        ...
                        site_divs
                            ...
                            .attr('data-tippy-content', function (d) {
                                var name_man;
                                if (field === 'emo_pers') {
                                    name_man = 'News containing emotional manipulations';
                                } else if (field === 'arg_pers') {
                                    name_man = 'News which manipulate with arguments';
                                } else {
                                    name_man = 'Manipulative news';
                                }
                                return `<h6>${d.comment || d.url_domain}</h6>
                            <p>Visits per month: ${d3.format(".2s")(d.ukr_audience)}</p>
